...
function MarkdownBuilder() {
  ...
  this.defaultConfig = {
    documentationPath: {
      ...
      value: './documentations/documentation.md'
    },
...
MarkdownBuilder.prototype.writedFilePath = function(fileName) {
  let filePath = this.config.documentationPath,
  hasMarkdownExt = filePath.slice(-3);

  if (hasMarkdownExt !== '.md' && !filePath.includes('.')) {
    filePath = filePath[filePath.length - 1] === '/' ? filePath + 'documentation.md' : filePath + '.md';
  }
