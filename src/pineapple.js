...
Pineapple.prototype.init = function() {
  ...
  if ( program.model ) {
    ...
    this.models.factories = program.model !== 'all' ? 
      this.models.factories.filter((value) => value.name === program.model.toLowerCase() ? value : false) : 
  ...
  if ( program.builder ) {
    ...
    this.builders.factories = program.builder !== 'all' ? 
      this.builders.factories.filter((value) => value.name === program.builder.toLowerCase() ? value : false) : 
...
Pineapple.prototype.buildAll = function() {
  this.builders.data.forEach((builder => {
    builder.build(this.models.data);
  }).bind(this));
};
