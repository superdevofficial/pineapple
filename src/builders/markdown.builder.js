const BaseBuilder = require('./base.builder.js'),
  path = require('path'),
  mkFeathersName = require('../templates/mk-feathers-name.twig'),
  mkFeathersServices = require('../templates/mk-feathers-services.twig');
